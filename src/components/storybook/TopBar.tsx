        ...
        <DropdownMenu>
          ...
          >
            <DropdownMenuItem className="cursor-pointer gap-3 py-2 px-3 focus:bg-gray-100 dark:focus:bg-gray-800">
              <span className="text-lg leading-none" role="img" aria-label="USA flag">
                🇺🇸
              </span>
              <div className="flex flex-col">
                <span className="text-sm font-medium">English</span>
                <span className="text-[10px] text-gray-500 underline-offset-2">United States</span>
              </div>
            </DropdownMenuItem>
            <DropdownMenuItem className="cursor-pointer gap-3 py-2 px-3 focus:bg-gray-100 dark:focus:bg-gray-800">
              <span className="text-lg leading-none" role="img" aria-label="China flag">
                🇨🇳
              </span>
              <div className="flex flex-col">
